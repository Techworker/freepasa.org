...
<?php include __DIR__ . '/include/head.php'?>
    ...
    <div class="container content">
        ...
        <p>
            Your phone number will be saved on the server after the PASA is distributed
            successfully. If the verification fails, it will be deleted after 1 hour.
        </p>
        <p>
        ...
        <p>
            The source code of this service is open sourced and accessible <a href="TODO">here</a>.
        </p>
